from gameTUL.sprites.attack_sprite import AttackSprite
from gameTUL.sprites.monster_level_sprite import MonsterLevelSprite
from gameTUL.sprites.monster_name_sprite import MonsterNameSprite
from gameTUL.sprites.monster_outline_sprite import MonsterOutlineSprite
from gameTUL.sprites.monster_sprite import MonsterSprite
from gameTUL.sprites.monster_stats_sprite import MonsterStatsSprite
...
class Battle:
	...
	def setup(self):
		for entity, monster in self.monster_data.items():
			for index, monster in {k:v for k,v in monster.items() if k < 1}.items():
