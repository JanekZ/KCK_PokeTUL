TRAINER_DATA = {
	'o1': {
		...
		'dialog': {
			'default': ['Hej, nowy tutaj?', 'Przed dalszym zwiedzaniem, zawalcz ze mną', 'Potyczka!'],
			'defeated': ['Gratuluje!', 'Kontynuuj zwiedzanie kampusu B']},
	...
	'o2': {
		...
		'dialog': {
			'default': ['Rozgrzewka przed plywaniem', 'Potyczka!'],
			'defeated': ['Idz sobie']},
		'directions': ['right'],
		'look_around': False,
		'defeated': False,
	...
	'o3': {
		'monsters': {0: ('Atrox', 14), 1: ('Pouch', 15), 2: ('Draem', 13), 3: ('Cindrill', 13)},
		'dialog': {
			'default': ['Szybki pojedynek przed zajeciami', 'Pojedynek!'],
			'defeated': ['Pokonales mnie', 'Nie mam nic wiecej do zaoferowania']},
	...
	'p1': {
		'monsters': {0: ('Friolera', 25), 1: ('Gulfin', 20), 2: ('Atrox',24), 3: ('Finiette', 30)},
		'dialog': {
			'default': ['Welcome in CJ!', 'Before you continue your journey you must complete the challenge'],
			'defeated': ['Congrats!','You beat me']},
		'directions': ['right'],
		'look_around': False,
		'defeated': False,
		'biome': 'forest'
	...
	'p2': {
		'monsters': {0: ('Friolera', 25), 1: ('Gulfin', 20), 2: ('Atrox',24), 3: ('Finiette', 30)},
		'dialog': {
			'default': ['Witamy w bibliotece', 'Przed dalsza podroza musisz wykonac wyzwanie'],
			'defeated': ['Gratulacje!', 'Pokonales mnie']},
		'directions': ['down'],
		'look_around': False,
		'defeated': False,
		'biome': 'forest'
	...
	'p3': {
		'monsters': {0: ('Friolera', 25), 1: ('Larvea', 20), 2: ('Atrox',24), 3: ('Ivieron', 30)},
		'dialog': {
			'default': ['Witamy w FTIMS!', 'Przed dalsza podroza musisz wykonac wyzwanie'],
	...
	'p5': {
		'monsters': {0: ('Friolera', 25), 1: ('Gulfin', 20), 2: ('Atrox',24), 3: ('Finiette', 30)},
		'dialog': {
			'default': ['Witam serdzenie na DMCS!', 'Przed dalsza podroza musisz wykonac wyzwanie'],
			'defeated': ['Gratulacje!', 'Pokonales mnie']},
		'directions': ['down'],
		'look_around': False,
		'defeated': False,
	...
	'Nurse': {
		...
		'look_around': False,
		'dialog': {
			'default': ['Witam w DMCS!', 'Pozwol, ze wylecze twe potwory', 'Gotowe'],
			'defeated': None},
		'directions': ['down'],
		'defeated': False,
		'biome': None
...
ATTACK_DATA = {
	...
	'heal':       {'target': 'player',   'amount': -1.2, 'cost': 80, 'element': 'plant',  'animation': 'green'},
